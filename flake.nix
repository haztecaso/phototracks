{
  description = "phototracks matches your photos with GPS locations based on timestamps from GPX track files";
  inputs = {
  ...
  outputs =
    ...
    let
      ...
      pyprojectOverrides = final: prev: {
        phototracks = prev.phototracks.overrideAttrs (old: {
    ...
    in {
      packages.x86_64-linux.default =
        pythonSet.mkVirtualEnv "phototracks-env" workspace.deps.default;

      apps.x86_64-linux = {
        default = {
          type = "app";
          program = "${self.packages.x86_64-linux.default}/bin/phototracks";
        };
      };
      ...
      devShells.x86_64-linux = let
        ...
        uv2nix = let
          ...
          virtualenv = (editablePythonSet.mkVirtualEnv "phototracks-dev-env"
